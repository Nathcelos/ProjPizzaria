...
public class CadastrarCardapio extends javax.swing.JFrame {
    ...
    public CadastrarCardapio(JFrame telaAnterior) {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(52, 199, 89));
        ...
        cbCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bebidas", "Pizzas Doces", "Pizzas Salgadas", "Porções" }));
...
cbCategoria.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarCardapio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
