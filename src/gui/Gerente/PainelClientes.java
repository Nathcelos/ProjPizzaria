...
public class PainelClientes extends javax.swing.JPanel {
    ...
    int totalHoje = dao.contarClientesHoje();
    lblHoje.setText(String.valueOf(totalHoje));
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Novos clientes hoje");

        lblHoje.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        lblHoje.setForeground(new java.awt.Color(0, 102, 0));
        lblHoje.setText("00");
